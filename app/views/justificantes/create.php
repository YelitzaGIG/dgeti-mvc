    ...
    <form method="POST" action="<?= APP_URL ?>/public/justificantes/store" class="create-form" id="createForm">
      ...
      <div class="form-section">
        ...
        <div class="alert alert-info">
          ...
          <span>
            No tienes ausencias pendientes de justificar. Si consideras que hay un error en tu registro de asistencia,
            acude <strong>de forma presencial</strong> con tu docente o tutor institucional para que realicen
  ...
  <div class="form-sidebar">
    <div class="section-card help-card">
      ...
      <ul class="help-list">
        ...
        <li>Para errores de asistencia, acude <strong>presencialmente</strong> con tu docente.</li>
      </ul>
    </div>
